...
public class Sberbank extends AccountBank{
    private double money = 77_000;

    public Sberbank(String name, String lastName, int numCard, String country) throws Exception {
    ...
    public void plusMoney(double transferMoney) throws Exception {
        if (transferMoney < 0 || transferMoney > 100_000) {
